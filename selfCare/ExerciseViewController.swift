...
//TODO: put exercises in alphabetical order, users can swipe left to delete, tap to mark as complete on the checkmark in each cell, sort things as done/ undone
    ...
    let exercises = ["Chest day", "Shoulders day", "Arms day", "Abs day", "Back day", "Butt day", "Legs day", "Pushups", "Planks", "Situps", "Crunches", "Sprints", "Runs", "Speed walks", "Squats", "Single-leg deadlifts", "Squat jumps", "Jumping Jacks", "Junmping lunges", "Reverse lunges", "Side lunges", "Spider lunges", "Walk outs", "Glute bridges", "Divebombers", "Bear Crawls", "One-leg wallsits", "Pull ups", "Calf raises", "Shoulder circles", "Box jumps", "Back extensions", "Chair dips", "Leg raises", "Mountain climbers", "Burpees"]
    /*
